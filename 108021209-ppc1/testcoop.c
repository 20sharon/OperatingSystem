...
__data __at (0x25) char P_C_buffer; // 25
__data __at (0x26) char P_C_bufferisempty; // 26
__data __at (0x27) char nextitem; // 27
    ...
    */
    ...
    while (1) {
        ...
        * and then write the new data into the buffer */
        while(P_C_bufferisempty == 0){  // not empty
            ThreadYield();
        }
...
*/
    ...
    ThreadID mainID = ThreadCreate(Producer);
    Consumer();
}
